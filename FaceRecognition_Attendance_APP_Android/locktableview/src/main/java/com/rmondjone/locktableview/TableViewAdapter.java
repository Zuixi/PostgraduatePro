...
public class TableViewAdapter extends RecyclerView.Adapter<TableViewAdapter.TableViewHolder> {
    ...
    public void setOnItemSelectedListenter(LockTableView.OnItemSelectedListenter onItemSelectedListenter) {
    ...
    public void onBindViewHolder(final TableViewHolder holder, int position) {
        ...
        if (mUnLockAdapter == null) {
            ...
            mUnLockAdapter.setOnItemSelectedListenter(new LockTableView.OnItemSelectedListenter() {
                @Override
