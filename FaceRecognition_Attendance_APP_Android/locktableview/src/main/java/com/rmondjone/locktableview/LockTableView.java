...
public class LockTableView {
    ...
    private LockTableView.OnItemSelectedListenter onItemSelectedListenter;
    /**
     * 构造方法
     *
     * @param mContext     上下文
...
//            Log.e("每行数据", mTableRowDatas.toString());
    ...
    private void initView() {
        ...
        mTableViewAdapter.setOnItemSelectedListenter(new LockTableView.OnItemSelectedListenter(){

            @Override
            public void onItemSelected(View item, int x, int y) {
                if (onItemSelectedListenter!=null){
                    onItemSelectedListenter.onItemSelected(item,x,y);
                }
    ...
    public LockTableView setOnItemSelectedListenter(OnItemSelectedListenter onItemSelectedListenter) {
    ...
    public interface OnItemSelectedListenter {
        void onItemSelected(View item, int y,int x);
    }
}
