...
public class UnLockColumnAdapter extends RecyclerView.Adapter<UnLockColumnAdapter.UnLockViewHolder> {
     ...
     */
    private void createRowView(LinearLayout linearLayout, List<String> datas, boolean isFristRow, int mMaxHeight, final int p) {
        //设置LinearLayout
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemSelectedListenter!=null){
                        onItemSelectedListenter.onItemSelected(v,p,finalI);
                    }
                }
            });
            //设置布局
